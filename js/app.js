(() => {
    ...
    function initSliders() {
        if (document.querySelector("#products")) {
            let menu = [ "Стандарт", "Бизнес", "Премиум ", "Эксклюзив" ];
            new swiper_core_Swiper("#products", {
                ...
                pagination: {
                    ...
                    renderBullet: function(index, className) {
                        return '<button type="button" class="' + "products__button" + " button " + className + '">' + "<span>" + menu[index] + "</span>" + "</button>";
                    }
                },
                navigation: {
        ...
        if (document.querySelector("#about")) {
            ...
            new swiper_core_Swiper("#about", {
                ...
                pagination: {
                    ...
                    clickable: true,
                    renderBullet: function(index, className) {
                        return '<button type="button" class="' + "products__button" + " button " + className + '">' + "<span>" + menuAbout[index] + "</span>" + "</button>";
                    }
                },
                breakpoints: {
                    0: {
        ...
        if (document.querySelector("#certificates-slider")) new swiper_core_Swiper("#certificates-slider", {
            modules: [ Navigation ],
        ...
        if (document.querySelector(".top-popup__slider_1")) new swiper_core_Swiper(".top-popup__slider_1", {
        ...
        if (document.querySelector(".top-popup__slider_2")) new swiper_core_Swiper(".top-popup__slider_2", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".top-popup__slider_3")) new swiper_core_Swiper(".top-popup__slider_3", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".top-popup__slider_4")) new swiper_core_Swiper(".top-popup__slider_4", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".top-popup__slider_5")) new swiper_core_Swiper(".top-popup__slider_5", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".top-popup__slider_6")) new swiper_core_Swiper(".top-popup__slider_6", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".top-popup__slider_7")) new swiper_core_Swiper(".top-popup__slider_7", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector("#installation-slider")) new swiper_core_Swiper("#installation-slider", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            freeMode: true,
            pagination: {
                el: "#installation-slider-pagin",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector("#glazing-slider")) new swiper_core_Swiper("#glazing-slider", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            freeMode: true,
            pagination: {
                el: "#glazing-slider-pagin",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector("#cottages-slider")) new swiper_core_Swiper("#cottages-slider", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            freeMode: true,
            pagination: {
                el: "#cottages-slider-pagin",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector("#objects-slider")) new swiper_core_Swiper("#objects-slider", {
            modules: [ Pagination, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    if (window.innerWidth > 991) {
        ...
        if (headerLinks.length) headerLinks.forEach((link => {
            link.addEventListener("mouseenter", (e => {
                link.classList.add("_hover");
            }));
            link.addEventListener("mouseout", (e => {
                link.classList.remove("_hover");
                link.classList.add("_hover-out");
                setTimeout((function() {
                    link.classList.remove("_hover-out");
                }), 400);
            }));
        }));
    }
    ...
    videoContainer.addEventListener("click", (function() {
        if (!videoContainer.classList.contains("video-playing")) {
            ...
            videoContainer.classList.toggle("video-playing");
            video.pause();
        }
    }));
    document.addEventListener("DOMContentLoaded", (function(e) {
        ...
        function init() {
            ...
            var myMap6 = new ymaps.Map("map-6", {
                center: [ 56.99394, 41.15326 ],
                zoom: 17,
                controls: []
            }, {
                searchControlProvider: "yandex#search"
            });
            var myMap7 = new ymaps.Map("map-7", {
                center: [ 56.969726, 41.123353 ],
                zoom: 17,
                controls: []
            }, {
                searchControlProvider: "yandex#search"
            ...
            var popupmark2 = new ymaps.Placemark([ 56.970937, 41.050112 ], {
                hintContent: "<p>Окна Хаус</p></br><p>Пример №2</p>"
            }, {
                iconLayout: "default#image",
                iconImageHref: "img/portfolio/location.svg",
            ...
            var popupmark3 = new ymaps.Placemark([ 56.992328, 41.031844 ], {
                hintContent: "<p>Окна Хаус</p></br><p>Пример №3</p>"
            }, {
                iconLayout: "default#image",
                iconImageHref: "img/portfolio/location.svg",
            ...
            var popupmark4 = new ymaps.Placemark([ 56.956034, 40.962592 ], {
            ...
            var popupmark5 = new ymaps.Placemark([ 56.990229, 40.941817 ], {
                hintContent: "<p>Окна Хаус</p></br><p>Пример №5</p>"
            }, {
                iconLayout: "default#image",
                iconImageHref: "img/portfolio/location.svg",
            ...
            var popupmark6 = new ymaps.Placemark([ 56.99394, 41.15326 ], {
                hintContent: "<p>Окна Хаус</p></br><p>Пример №6</p>"
            }, {
                iconLayout: "default#image",
                iconImageHref: "img/portfolio/location.svg",
            ...
            var popupmark7 = new ymaps.Placemark([ 56.969726, 41.123353 ], {
                hintContent: "<p>Окна Хаус</p></br><p>Пример №7</p>"
            }, {
                iconLayout: "default#image",
                iconImageHref: "img/portfolio/location.svg",
            ...
            function setBalloonPane(map, placemark, mapData) {
                ...
                var mapSize = map.container.getSize(), mapBounds = [ [ mapData.globalPixelCenter[0] - mapSize[0] / 2, mapData.globalPixelCenter[1] - mapSize[1] / 2 ], [ mapData.globalPixelCenter[0] + mapSize[0] / 2, mapData.globalPixelCenter[1] + mapSize[1] / 2 ] ], balloonPosition = placemark.balloon.getPosition(), zoomFactor = Math.pow(2, mapData.zoom - map.getZoom()), pointInBounds = ymaps.util.pixelBounds.containsPoint(mapBounds, [ balloonPosition[0] * zoomFactor, balloonPosition[1] * zoomFactor ]), isInOutersPane = placemark.options.get("balloonPane") == "outerBalloon";
                if (!pointInBounds && isInOutersPane) placemark.options.set({
                    balloonPane: "balloon",
                    balloonShadowPane: "shadows"
                }); else if (pointInBounds && !isInOutersPane) placemark.options.set({
                    balloonPane: "outerBalloon",
                    balloonShadowPane: "outerBalloon"
                });
            }
            myMap.geoObjects.add(placemark1).add(placemark2).add(placemark3).add(placemark4).add(placemark5).add(placemark6).add(myPlacemark).add(placemark7);
            myMap1.geoObjects.add(popupmark1);
            myMap2.geoObjects.add(popupmark2);
            myMap3.geoObjects.add(popupmark3);
            myMap4.geoObjects.add(popupmark4);
            myMap5.geoObjects.add(popupmark5);
            myMap6.geoObjects.add(popupmark6);
            myMap7.geoObjects.add(popupmark7);
            observeEvents(myMap);
        }
    }));
    const blocks = document.querySelectorAll(".scrolling");
